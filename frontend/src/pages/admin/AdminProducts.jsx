        ...
        <DialogContent className="bg-slate-900 border-slate-800 text-white max-w-2xl">
          ...
          <div className="space-y-6">
            <div className="bg-slate-800 border border-slate-700 rounded-lg p-4">
              <h4 className="text-sm font-semibold text-white mb-2">Required Columns:</h4>
              <div className="grid grid-cols-2 gap-2 text-sm text-slate-300">
                <div>• comp_name (Brand)</div>
                <div>• machine_model</div>
                <div>• track_size</div>
                <div>• Price</div>
                <div>• eng_description</div>
                <div>• title_h1</div>
                <div>• sub_title_h2</div>
                <div>• page_title</div>
                <div>• eng_metakeyword</div>
                <div>• eng_meta_desc</div>
                <div>• shown_main_listin</div>
              </div>
            </div>
            ...
            <div>
              <Label className="text-white mb-2 block">Select File (CSV or Excel)</Label>
              <input
                type="file"
                accept=".csv,.xlsx,.xls"
                onChange={(e) => setImportFile(e.target.files[0])}
                className="w-full bg-slate-800 border border-slate-700 rounded-md px-3 py-2 text-white file:mr-4 file:py-2 file:px-4 file:rounded file:border-0 file:text-sm file:bg-orange-500 file:text-white hover:file:bg-orange-600"
              />
              {importFile && (
